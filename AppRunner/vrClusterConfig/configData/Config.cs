...
namespace vrClusterConfig
{
    public class Config : INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        public Config()
        {
            ...
            selectedSceneNodeView = new SceneNodeView();


            cameraLocationX = string.Empty;
            cameraLocationY = string.Empty;
            cameraLocationZ = string.Empty;
            cameraTracker = null;
            cameraTrackerCh = string.Empty;
        ...
        string CreateListCfg<T>(ref List<T> list) where T : IConfigItem
        {
